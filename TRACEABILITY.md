...
отсутствующий индекс внешнего ключа `studkab_gen_jobs.passport_id`; исправление
вынесено в отдельную миграцию `20260915070935`. Платных вызовов не было.

Этап 1 остаётся незавершённым до установки индекса, финального CI, публикации
интерфейса и неплатной проверки опубликованной страницы.
