...
не было. Browser-приёмка локально не запустилась из-за отсутствия Chromium; CI ещё
не выполнялся. Production, Edge, GitHub Pages и рабочие данные не изменены.
...
Этап 1 остаётся незавершённым до CI, установки и неплатной рабочей проверки.
