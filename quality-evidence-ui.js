(function(global){
 ...
 function mount(host,options){
  ...
  function render(){
   ...
   body.querySelector('[data-quality-required-threshold]').hidden=req.mode!=='university_threshold';
   ...
   body.querySelector('[data-quality-save-external]').onclick=function(){return run(async function(){
    ...
    payload.thresholdMode=req.mode;payload.thresholdPercent=req.mode==='university_threshold'?req.thresholdPercent:null;
