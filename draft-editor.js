(function(global){
 ...
 function check(x){
  var acceptance=DraftQuality.documentAcceptance(x),errors=DraftQuality.preflight(x).concat(DraftQuality.issues(x.doc),DraftQuality.sourceCheck(x).errors,DraftQuality.consistency(x).errors,acceptance.errors,DraftQuality.finAcceptance(x).errors);
