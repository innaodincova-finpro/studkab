...
(function(global){
 ...
 function invitationMessage(email,url,kind){
  ...
  var start=kind==='existing'?
   '1. Войдите в кабинет\n'+home+'\nОткройте «Профиль» → «Хранение записей». Войдите через Google с этой почтой или по почте и паролю приложения. Новый аккаунт создавать не нужно. Если не получается войти, обратитесь к исполнителю в переписке, в которой получено приглашение.':
